...
?>
	...
	<body>
		<div id='panel_control'>
			...
			<div div='diapo'>
				...
				<button title='crea multiples lineas de texto con la información necesaria.' onclick="crear_div()">crear texto</button>
	...
	<div id='div_titulo' class='div_texto' onclick="ver_buttons('buttons_bar')"  >
		<span id='id_text' class='text' style='font-size:2em' >Introduce un texto</span>


		<div id="buttons_bar" class='buttons_bar'>
			
		<button onclick="hide_buttons()">


			<img src="ico_close.png" alt="x" /></button>
			...
			<select onchange="select_font('id_text',this.value,'buttons_bart')">
